...
public class Main {
     ...
     *
     * It can be used to create ordinary class instances or if you have a method with
     * a large parameter list, it can be replaced by a class where you use this pattern
     * for its creation.
     *
     ...
     *   - Easier to fill in the argument list, the IDE only shows the next argument in the chain.
     *     When you for example writes Car.create() followed by a dot, your IDE will
     *     help you by showing you the name of the first argument in the method chain,
     *     the second argument is shown when pressing dot after the first argument and so on.
